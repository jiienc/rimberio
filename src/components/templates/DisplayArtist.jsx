    ...
    return (
        <>
            ...
            <div className='flex items-center gap-8 mt-10'>
                ...
                <div
                    className='border-2 border-neutral-500 hover:border-white pt-1 pb-1 pl-2 pr-2 rounded-full flex items-center justify-center cursor-pointer'>
            ...
            <div className="flex">
                <div className="flex-1 p-4">
                    <h2 className="text-white text-2xl font-bold mb-7 mt-5">Discography</h2>
                </div>
            </div>
        </>
    );
